...
<?php session_start(); ?>
  ...
  <?php
    ...
    where b1.book_detail_id = '".$_GET['id']."' limit 1 ";
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;&nbsp;
<a href="insert.php?id= <?php echo $row_list['book_detail_id'];?>" > <button type="button"  class="btn btn-danger" > ย้อนกลับ </button></a>
