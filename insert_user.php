...
<form method="POST" action="insert_save_user.php"  enctype="multipart/form-data" class="form-horizontal"  >
<fieldset>

<!-- Form Name -->
<p align="right"><?php echo "User: ".$_SESSION["book_login_username"]." &nbsp; "?></p>
<br>
<p align="left"> &nbsp; <a href="form_book_in_user.php" class="btn btn-warning"> หนังสือเข้า </a> 
<a href="form_book_out_user.php" class="btn btn-info"> หนังสือออก </a>  
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
...
<table class="table table-sm table-dark" width="85%" align="center">
  ...
  <tr>
    ...
    <a href="form_update_user.php?id=<?php echo $row_list['book_detail_id'];?>"><button type="button" class="btn btn-success"> แก้ไข </button></a>
