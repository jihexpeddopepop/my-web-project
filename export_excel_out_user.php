...
<html> 
  ...
  <h4><strong><center scope="col">เอกสาร</center></h4></th>
					...
					<table border="1" class="table table-hover" >
						<thead>
							<tr class="info">
              <th width="100%"><h4><strong><center scope="col">วันที่</h4></th></center></strong>
              <th width="100%"><h4><strong><center scope="col">ชื่อหนังสือ</h4></th></center></strong>
              <th width="100%"><h4><strong><center scope="col">หนังสือออก</h4></th></center></strong>
              <th width="100%"><h4><strong><center scope="col">หนังสือรับ</h4></th></center></strong>
							</tr>
						</thead>
            ...
            where b1.book_detail_dept2 = '{$_GET["dep2"]}' and b1.book_detail_dept1 ='{$_SESSION["booK_dept_id"]}'
