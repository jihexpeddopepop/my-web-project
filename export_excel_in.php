...
<html> 
  ...
  <center>เอกสาร</center>
            ...
            <tr class="info">
              ...
              <th width="100%"><h4><strong><center scope="col">จากหน่วยงาน</h4></th></center></strong>
              <th width="100%"><h4><strong><center scope="col">ถึงหน่วยงาน</h4></th></center></strong>
							</tr>
						</thead>
            <?php
      ...
      where b1.book_detail_dept1 = '{$_GET["dep2"]}'
