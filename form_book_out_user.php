...
<table class="table table-sm table-dark" width="85%" align="center">
    <thead >
      ...
      <th><h4><center scope="col">หนังสือออก</h4></th></center>
 ...
 if($_POST["txt_book_detail_dept" ]== 'all' )
 {
   ...
   where b1.book_detail_dept1='{$_SESSION["booK_dept_id"]}' 
 ...
 else
 {
   ...
   LEFT OUTER JOIN book_dept b3 ON b3.book_dept_id = b1.book_detail_dept2
   where b1.book_detail_dept1='{$_SESSION["booK_dept_id"]}' 
  and b1.book_detail_dept2 = '{$_POST["txt_book_detail_dept"]}'
...
<p align="center"> &nbsp; 
  ...
  <a href="export_excel_out_user.php?d1=<?php echo $_POST['date_1'];
