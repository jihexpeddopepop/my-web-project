			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-5">
		      	...
		      	<h3 class="text-center mb-4">Have an account?</h3>
						...
						<form action="login_user_check.php" method="post" class="form-group">
		      		<div class="form-group">
		      			<input type="text" name="txt_username" class="form-control rounded-left" placeholder="username" required>
		      		</div>
